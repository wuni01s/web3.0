import { Plugin as EnvelopPlugin, PromiseOrValue, OnExecuteHook, OnSubscribeHook } from '@envelop/core';
import { ExecutionResult } from 'graphql';
import { ExecutionPatchResult, FetchAPI, GraphQLParams, MaybeArray, YogaInitialContext } from '../types.cjs';
export declare type Plugin<PluginContext extends Record<string, any> = {}, TServerContext = {}, TUserContext = {}> = EnvelopPlugin<YogaInitialContext & PluginContext> & {
    /**
...
export declare type RequestParser = (request: Request) => PromiseOrValue<GraphQLParams> | PromiseOrValue<GraphQLParams[]>;
...
export declare type OnParamsHook = (payload: OnParamsEventPayload) => PromiseOrValue<void>;
...
export declare type ExecutorResult = ExecutionResult | AsyncIterable<ExecutionResult> | AsyncIterable<ExecutionPatchResult>;
export declare type ResultProcessorInput = MaybeArray<ExecutionResult> | AsyncIterable<ExecutionResult> | AsyncIterable<ExecutionPatchResult>;
export declare type ResultProcessor = (result: ResultProcessorInput, fetchAPI: FetchAPI, acceptedMediaType: string) => PromiseOrValue<Response>;
