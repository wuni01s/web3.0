import { print, execute, parse, validate, subscribe, specifiedRules, } from 'graphql';
import { envelop, useEngine, useExtendContext, useLogger, useMaskedErrors, } from '@envelop/core';
    ...
    constructor(options) {
        ...
        this.maskedErrorsOpts =
            options?.maskedErrors === false
                ? null
                : {
                    maskError: (error, message) => yogaDefaultFormatError({
                        error,
                        message,
